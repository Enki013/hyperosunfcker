...
import com.hyperosunfcker.BuildConfig
...
import com.hyperosunfcker.ui.component.SettingsTextItem
import com.hyperosunfcker.ui.viewmodel.SettingsViewModel
import com.hyperosunfcker.util.DEFAULT_BLOAT_COMMITS_URL
import com.hyperosunfcker.util.DEFAULT_BLOAT_URL
    ...
    Scaffold(
        ...
        Column(
            ...
            Column(
                ...
                // App homepage
                Text(
                    text = "HyperOSUnf*cker",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.primary,
                    textAlign = TextAlign.Center,
                    modifier = Modifier.clickable {
                        val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/Enki013"))
