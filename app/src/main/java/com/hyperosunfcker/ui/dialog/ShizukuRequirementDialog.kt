package com.hyperosunfcker.ui.dialog
...
import com.hyperosunfcker.SHIZUKU_PACKAGE_NAME
import com.hyperosunfcker.ui.theme.GreenOk
import com.hyperosunfcker.ui.theme.Orange
import com.hyperosunfcker.util.shizuku.ShizukuPermission
import com.hyperosunfcker.util.shizuku.ShizukuStatus
    ...
    BasicAlertDialog(
        ...
        Column(
            ...
            Column(
                ...
                // Authorize this app
                RequirementItem(
                    text = stringResource(R.string.grant_shizuku_permission_to_app),
                    isCompleted = shizukuStatus == ShizukuStatus.ACTIVE && ShizukuPermission.isAppAuthorized(),
                    onActionClick = {
