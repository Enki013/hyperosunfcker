...
private const val DONATE_URL = "https://github.com/Enki013/hyperosunfcker"
    ...
    BasicAlertDialog(
        ...
        Surface(
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.optimizer_donate_request),
                    style = MaterialTheme.typography.bodyMedium,
                )
                ...
                Row(
                    ...
                    Button(
                        onClick = {
                            onDismissRequest()
                            // Open the project page for support options.
