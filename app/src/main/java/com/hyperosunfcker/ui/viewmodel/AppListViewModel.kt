...
import com.hyperosunfcker.extension.getAllPackagesInfo
import com.hyperosunfcker.extension.mutableStateSetOf
import com.hyperosunfcker.packageName
import com.hyperosunfcker.util.BloatData
import com.hyperosunfcker.util.BloatUtils
...
class AppListViewModel : ViewModel() {
    ...
    suspend fun loadInstalled(packageManager: PackageManager, context: Context) {
        ...
        withContext(Dispatchers.IO) {
            ...
            bloatMap[packageName] = optimizerBloatData(context)
...
private fun optimizerBloatData(context: Context): BloatData {
    return BloatData(
            installData = null,
            description =
                    context.getString(
                            R.string.optimizer_description,
