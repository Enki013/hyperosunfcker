package com.hyperosunfcker.ui.component
...
import com.hyperosunfcker.util.BloatData
import com.hyperosunfcker.util.InstallData
import com.hyperosunfcker.util.LogUtils
import com.hyperosunfcker.util.RemovalRecommendation
import com.hyperosunfcker.util.apps.AppInfo
...
@Preview
@Composable
fun HyperOSUnfckerAppTileDemo() {
    AppTile(
            appInfo =
                    AppInfo(
                            "HyperOSUnf*cker",
                            packageName = "com.hyperosunfcker",
                            isSystemApp = false,
                            isDisabled = false,
                            isUninstalled = false,
                            versionCode = 1,
                            ...
                            bloatData =
                                    BloatData(
                                            ...
                                            description = "HyperOSUnf*cker is not a system app",
            ...
            appInfo =
                    AppInfo(
                            ...
                            bloatData =
                                    BloatData(
                                            installData = InstallData.OEM,
                                            description = "HyperOSUnf*cker is a system app",
                                            removal = RemovalRecommendation.RECOMMENDED,
                                    ),
                    ),
            isSelected = false,
