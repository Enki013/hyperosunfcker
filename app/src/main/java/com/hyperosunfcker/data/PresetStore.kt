...
import com.hyperosunfcker.data.proto.DebloatPreset
import com.hyperosunfcker.data.proto.PresetsList
import com.hyperosunfcker.extension.getInfoForPackage
...
class PresetStore(private val context: Context) {
    ...
    val presetsFlow: Flow<List<DebloatPresetData>> =
    ...
    suspend fun savePreset(preset: DebloatPresetData): Boolean {
        return try {
            context.presetDataStore.updateData { currentPresets ->
                val protoPreset =
                        DebloatPreset.newBuilder()
                                .setName(preset.name)
    ...
    suspend fun deletePreset(preset: DebloatPresetData): Boolean {
        return try {
            context.presetDataStore.updateData { currentPresets ->
                currentPresets
                        .toBuilder()
    ...
    fun exportToJson(preset: DebloatPresetData): String {
    ...
    fun importFromJson(jsonString: String): DebloatPresetData? {
        return try {
