...
import com.hyperosunfcker.ui.HyperOSUnfckerApp
import com.hyperosunfcker.ui.theme.HyperOSUnfckerTheme
import com.hyperosunfcker.util.LogUtils
import com.hyperosunfcker.util.shizuku.ShizukuPackageInstallerUtils
import org.lsposed.hiddenapibypass.HiddenApiBypass
import rikka.shizuku.Shizuku

const val SHIZUKU_PACKAGE_NAME = "moe.shizuku.privileged.api"
const val APP_NAME = "HyperOSUnf*cker"
const val packageName = "com.hyperosunfcker"
...
class MainActivity : FragmentActivity() {
    ...
    private fun uninstallApp(packageName: String, resetToFactory: Boolean = false): Boolean {
        ...
        val broadcastIntent = Intent("com.hyperosunfcker.UNINSTALL_RESULT_ACTION")
    ...
    private fun reinstallApp(packageName: String): Boolean {
        ...
        val broadcastIntent = Intent("com.hyperosunfcker.INSTALL_RESULT_ACTION")
        val intent =
